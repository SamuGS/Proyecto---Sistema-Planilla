...
{
    // Logo
    $this->Image('imagenes/pro2.png',5,8,20);
    // Arial bold 15
    $this->SetFont('Arial','B',15);
    // Movernos a la derecha
    $this->Cell(40);
    // Título
    $this->Cell(100,10,'Reporte de Pedidos',1,0,'C');
...
while($resultado = mysqli_fetch_array($consulta)){
	...
	$pdf->Cell(25,6,$resultado['entrega'],1,0,'C',$fill);
	$pdf->Cell(20,6,$resultado['hora'],1,0,'C',$fill);
